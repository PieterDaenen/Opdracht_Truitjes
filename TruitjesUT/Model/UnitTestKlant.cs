...
namespace TruitjesUT.Model
{
    public class UnitTestKlant
    {
        ...
        {
            Klant klant = new Klant();
            Bestelling a = new Bestelling(DateTime.Now);
            a.ZetBestellingNr(1);
            Bestelling b = new Bestelling(DateTime.Now);
            b.ZetBestellingNr(2);
            Bestelling c = new Bestelling(DateTime.Now);
            c.ZetBestellingNr(3);
            Bestelling d = new Bestelling(DateTime.Now);
            d.ZetBestellingNr(4);
            Bestelling e = new Bestelling(DateTime.Now);
            e.ZetBestellingNr(5);
        ...
        public void Test_Korting_Valid_20()
        {
            ...
            Bestelling e = new Bestelling(DateTime.Now);
            e.ZetBestellingNr(5);
            Bestelling f = new Bestelling(DateTime.Now);
            f.ZetBestellingNr(6);
            Bestelling g = new Bestelling(DateTime.Now);
            g.ZetBestellingNr(7);
            Bestelling h = new Bestelling(DateTime.Now);
            h.ZetBestellingNr(8);
            Bestelling i = new Bestelling(DateTime.Now);
            i.ZetBestellingNr(9);
            Bestelling j = new Bestelling(DateTime.Now);
